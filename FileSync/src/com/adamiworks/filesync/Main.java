...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (showInfo) {
			...
			System.out.println("THIS PROGRAM IS DISTRIBUTED UNDER GNU GPLv3 LICENCE. READ LICENSE.TXT FOR FURTHER DETAILS.");
			System.out.println("");
			System.out.println("   Usage for secure method (slow, uses MD5 hash)");
			System.out.println("      java -jar FileSync.jar <source dir> <destination dir> secure");
			System.out.println("");
			...
			FileSync fs = null;
			if (args.length == 3 && args[2].toLowerCase().equals("secure")) {
				fs = new FileSync(true);
			} else {
				fs = new FileSync(false);
			}
